...
def create_parser() -> argparse.ArgumentParser:
    ...
    push_parser.add_argument("--rhtl-provenance-public-key", default=os.getenv("RHTL_PROVENANCE_PUBLIC_KEY"), help="Immutable RHTL provenance public key for RHTL provenance verification")
...
def handle_push(args: argparse.Namespace) -> int:
    ...
    try:
        tag_name = publisher.publish_source(
            ...
            rhtl_provenance_public_key=args.rhtl_provenance_public_key,
